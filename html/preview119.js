...
let isTablet = false;//타블렛 기기 체크 확인 변수
...
window.addEventListener('DOMContentLoaded', function(){
	...
	if(document.querySelector('.btn-top') != null){
		document.querySelector('.btn-top').addEventListener('click', function(){
			let target = window;
			if(document.querySelector('.layout-framing') != null){
				target = document.querySelector('#wrap > .inner');
			}
	...
	//본문 스크롤
	let content_scroller = window;
	if(document.querySelector('html.layout-framing') != null)
		content_scroller = document.querySelector('#wrap > .inner');
	if(document.querySelector('.layout-framing') && content_scroller != window && document.querySelector('#wrap').offsetHeight < content_scroller.scrollHeight){
		content_scroller.querySelector('.scroll-indicator').style.display = 'block';
	}
	content_scroller.addEventListener("scroll", function(event){
		let height = content_scroller == window ? content_scroller.pageYOffset : content_scroller.scrollTop;
		let btntop = document.querySelector('.btn-top');
		if(content_scroller != window && content_scroller.querySelector('.scroll-indicator') != null && content_scroller.querySelector('.scroll-indicator').style.display != 'none'){
			content_scroller.querySelector('.scroll-indicator').style.display = 'none';
		}
		if ( btntop != null ){
			if(height > 160){
	...
	//사이드바 스크롤
	if(document.querySelector('.layout-framing') && document.querySelector('#wrap').offsetHeight < document.querySelector('#sidebar').scrollHeight){
		document.querySelector('#sidebar .scroll-indicator').style.display = 'block';
	}
	document.querySelector('#sidebar').addEventListener("scroll", function(event){
		if(document.querySelector('#sidebar .scroll-indicator') != null && document.querySelector('#sidebar .scroll-indicator').style.display != 'none'){
			document.querySelector('#sidebar .scroll-indicator').style.display = 'none';
		}
		event.stopPropagation();
	});
	...
	window.addEventListener("resize", function(){
		checkMobile();
		setMobileCategory();
		if(document.querySelector('#sidebar.on') != null){
...
function setProgress() {          
    let topPos = document.querySelector('.layout-framing') == null ? document.documentElement.scrollTop : document.querySelector('#wrap > .inner').scrollTop;
    let remain = document.querySelector('.layout-framing') == null ? document.documentElement.scrollHeight - document.documentElement.clientHeight : document.querySelector('#wrap > .inner').scrollHeight - document.querySelector('#wrap > .inner').clientHeight;
