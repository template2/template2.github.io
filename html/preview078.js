		...
		$(window).scroll(function(){
			...
			if($is_mobile){
				if($(window).scrollTop() > 100){
					$('.nav').addClass('on');
					$('#header').addClass('on');
					if($('body.cover-slider-header #header .cover-slider').length){
						$('body.cover-slider-header #header .cover-slider').detach().prependTo('#content > .inner');
						$('#header').css('height','55px');
					}
				}else{
					$('.nav').removeClass('on');
					$('#header').removeClass('on');
					if($('body.cover-slider-header #content .cover-slider').length){
						$('body.cover-slider-header #content .cover-slider').detach().appendTo('#header');
						$('#header').css('height','400px');
					}
				}
			}else{
