(function($) {
	...
	//모바일에서 아이프레임 감싸서 ㅅ와이프로 볼 수 있게 함.
	function iframeWrap(){
		...
		$(".post-item, .recent-posts > li, .cover-list ul li").each(function(){
			if(!$(this).find('.thum img').length){
				if($('body.place-thumbnail').length){
					$(this).find('.thum').append('<img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAIAAAABCAQAAABeK7cBAAAADUlEQVR42mP8X8/AAAAFgwGANbMDjQAAAABJRU5ErkJggg==">');
