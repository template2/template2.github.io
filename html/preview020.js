(function($) {
	...
	function setTimeLine(){
		...
		$(".timeline-date").each(function(){
			arr_postdate = arr_today = $(this).html().split(' ');
			$(this).html('<span class="ymd">'+( arr_postdate[0]==todayymd?(($is_mobile?'<br/> ':'')+'오늘'):( $is_mobile?arr_postdate[0].replace(/\./gi,'<br/>'):arr_postdate[0] ) )+'</span><br/><span class="hms">'+arr_postdate[1]+'</span>')
		})	
	}
